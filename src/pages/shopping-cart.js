...
export default function ShoppingCart() {
    ...
    useEffect(() => {
        ...
        axios
            .get("http://abazarak.ir/api/ordering/cart/")
            .then((response) => {
    ...
    const changeProduct = (id, type) => {
        ...
        axios
            .post(
                "http://abazarak.ir/api/ordering/cart/change-item/",
    ...
    const setBonus = (code) => {
        if (code.length === 0) {
            ...
            axios
                .post(
                    "http://abazarak.ir/api/ordering/cart/apply-cupon/",
                    { code: `${code}` }
                )
                .then((response) => {
    ...
    const removeBonus = () => {
        ...
        axios
            .post(
                "http://abazarak.ir/api/ordering/cart/remove-cupon/"
            )
            .then((response) => {
